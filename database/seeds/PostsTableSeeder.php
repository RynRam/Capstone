...
class PostsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $info = array("Looking for the right wedding catering services for your upcoming marriage might be a straightforward affair. But even if you already have a catering service and a concept in mind, how can you make it happen without the right venue?",
        	...
        	"Original article courtesy of Bride and Breakfast This couple is taking grand to the next level with their wedding–especially with their gorgeous reception styling! The flowers, the lights, the whole setup by Gideon Hermosa was just so beautiful.",
