...
<div id="sidebar">
  ...
  <li class="submenu"><a><i class="icon  icon-edit"></i> <span>Posts</span></a>
        <ul>
        <li> <a href="{{url('/admin/post')}}"><i class="icon icon-pencil "></i> <span>Blogs</span><span class="label label-important"></span></a> </li>
        <li> <a href="{{url('/admin/discount')}}"><i class="icon icon-info-sign"></i> <span>Discounts</span> <span class="label label-important"></span></a></li>
        </ul>
  </li>
  ...
  <li class="submenu"><a href="{{url('/admin/manpower')}}"><i class="icon icon-sitemap"></i> <span>Manpower</span></a>
    <ul>
      ...
      <li ><a href="{{url('/admin/manpowerroles')}}"><i class="icon icon-th"></i> <span>Manpower Roles</span></a></li>
