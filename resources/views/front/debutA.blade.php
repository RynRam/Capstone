              ...
              <p>
                <ul>
                    ...
                    <li style="list-style: none;"><b>Flowers</b>
                        <ul>
                            <li>18 Long Stemmed roses for the Cotillion Entourage</li>
                            <li>1 Bouquet Flower for the Debutant </li>
                            <li>Floral Ark at the back design stage décor (full arrangements)</li>
                            <li>Flowers at Registration Table</li>
                            <li>Flowers at Cake Table</li>
                            <li>Flowers at Presidential Table </li>
                            <li>Flowers at Center Table</li>
                        </ul>
                    </li>
                    <li style="list-style: none;"><b>Tables</b>
                        <ul>
                            <li>Presidential Table at 8 pax only. Long table with full arrangements flowers at centerpiece</li>
                            <li>Round table for guest </li>
                            <li>With Buffer or Free extra table for Guest</li>
                    ...
                    <li style="list-style: none;"><b>Amenities</b>
                        <ul>
                            ...
                            <li>Elegant buffet with spotlight and Centerpiece props </li>
                            <li>Glass centerpiece on each individual table with candles</li>
                            ...
                            <li>Red Carpet</li>
                            <li>Fine Dining Seat-up at Guest table</li>
                            <li>Manage Buffet</li>
                            <li>Extra waiters for roving</li>
                            <li>18 Candles and Candle Stand</li>
                            <li>Stage Set up </li>
                        </ul>
                    </li>
                    <li style="list-style: none;"><b>Beverages</b>
                        <ul>
                            <li>Iced Tea 3 glasses ( with Lemon and Honey…Nestle Products ) </li>
                            <li>Soft drink 3 glasses </li>
                            <li>Tube Ice</li>
                            <li>Purified Drinking Water  </li>
                            <li>1 Tequila Bottle for 18 shots </li>
                        </ul>
                    </li>
                    <li style="list-style: none;"><b>Stage Décorations</b>
                        <ul>
                            <li>Backdraft Palo china, Cleopatra sofa, Lights Pillar, Grass Design Backdraft, Bulb Lights, Design Stage, Flowers Design, Console Table, Platform with Carpet and Styro name Cut.</li>
                        </ul>
                    </li>
                    <li style="list-style: none;"><b>Services</b>
                        <ul>
                            <li>Welcome drinks and Appetizer serve when the guest arrive</li>
                            <li>Registration Table</li>
                            <li>One free guest table </li>
                            <li>20% Buffer on Food Serving</li>
                            <li>More Service Staff</li>
                            ...
                            <li>Free ice tube on liquors </li>
