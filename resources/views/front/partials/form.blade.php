        ...
        <ul id="progressbar" style="display:none;">
         ...
         <h2 class="fs-title">Reservation</h2>
          ...
          <a href="/customer-login"><input type="button" name="next" class="next action-button" value="Next" /></a>
                ...
                <input type="button" name="next" class="action-button" value="Next" id="showPrice"/> 
                @endif
            ...
            <div><input type="button" name="btnSubmit" id="btnSubmit" value="Paypal Pay Now" class="action-button submit" style="background:#0070ba;width:200px;"></div>
